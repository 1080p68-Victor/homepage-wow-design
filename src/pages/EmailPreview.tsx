...
import { Copy, Check, Mail, Smartphone, Monitor } from 'lucide-react';
...
const EmailPreview = () => {
  ...
  const emailHTML = getWelcomeEmailHTML({ customerName, shopUrl: window.location.origin });
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Welcome Registration Email</p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <iframe
              ...
              style={{ height: viewMode === 'mobile' ? '700px' : '900px' }}
            />
          </div>
